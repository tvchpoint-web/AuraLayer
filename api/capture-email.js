...
export default async function handler(req, res) {
  ...
  if (RESEND_API_KEY) {
    try {
      ...
      console.log('[Resend] status:', resendRes.status, 'response:', JSON.stringify(resendData));
    } catch (err) {
...
<table width="600" cellpadding="0" cellspacing="0" border="0" style="background-color:#F5EFE4;max-width:600px;">
              ...
              <td style="padding-right:12px;vertical-align:top;padding-top:2px;">
                <table cellpadding="0" cellspacing="0" border="0" style="background:#FF0000;border-radius:6px;">
                  <tr><td style="padding:5px 10px;">
                    <span style="font-size:11px;font-weight:900;color:#FFFFFF;white-space:nowrap;">&#9654; YouTube</span>
                  </td></tr>
                </table>
              </td>
  ...
  <tr><td style="padding:0 28px 36px;">
    <p style="font-size:14px;color:#6B6358;line-height:1.75;margin:0 0 10px;">
    ...
    <p style="font-size:13px;color:#9A9690;line-height:1.6;margin:0;">
      P.S. — If this landed in spam, move it to Primary. You'll want to see what comes next.
    </p>
  </td></tr>

  <!-- FOOTER -->
  <tr><td style="padding:20px 28px;border-top:1px solid rgba(26,21,16,0.08);">
    <p style="font-size:11px;color:#9A9690;margin:0;line-height:1.6;">
