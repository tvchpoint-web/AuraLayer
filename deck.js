    ...
    function tick() {
      ...
      if (step < 4) {
        ...
        stepT = setTimeout(function() {
          ...
          setTimeout(function() { var t=document.getElementById('tag-2'); if(t) t.style.opacity='1'; }, 200);
          setTimeout(function() { var t=document.getElementById('tag-3'); if(t) t.style.opacity='1'; }, 400);
          if (done) done();
        }, 300);
      }
    }
